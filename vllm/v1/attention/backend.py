...
class CommonAttentionMetadata:
    ...
    """DFlash pseudo-autoregressive micro-block size, if enabled."""
    dflash_anchor_len: int = 1
    """Number of leading synthetic DFlash positions treated as anchors."""
    dflash_block_size: int | None = None
    """Full DFlash draft block size, including anchor/bonus positions."""
    custom_attn_mask: torch.Tensor | None = None
    """Optional backend-specific dense attention mask."""
